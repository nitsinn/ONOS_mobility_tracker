...
def topology(args):
    ...
    info("*** Creating core network (12 switches)\n")
    ...
    core5 = net.addSwitch('core5', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core6 = net.addSwitch('core6', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core7 = net.addSwitch('core7', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core8 = net.addSwitch('core8', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core9 = net.addSwitch('core9', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core10 = net.addSwitch('core10', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core11 = net.addSwitch('core11', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')
    core12 = net.addSwitch('core12', cls=OVSKernelSwitch, protocols='OpenFlow13', failMode='secure')

    core_switches = [core1, core2, core3, core4, core5, core6, core7, core8, core9, core10, core11, core12]
    ...
    net.addLink(core8, core9)
    net.addLink(core9, core10)
    net.addLink(core10, core11)
    net.addLink(core11, core12)
    ...
    info("*** Adding links\n")
    net.addLink(ap1, core2)
    net.addLink(ap2, core4)
    net.addLink(ap3, core6)
    net.addLink(ap4, core8)
    net.addLink(ap5, core10)
    net.addLink(ap6, core12)
